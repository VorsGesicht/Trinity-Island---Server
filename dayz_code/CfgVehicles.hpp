...
class CfgVehicles {
	...
	class AH6X_DZT: AH6_Base_EP1
	{
		displayname = "AH6X Little Bird";
		displaynameshort = "AH6X_DZT";
		vehicleClass = "Trinity Island";
		audible = 6;
		enablemanualfire = 0;
		scope = 2;
		side = 2;
		...
		maxSpeed = 282;	// max speed on level road, km/h - buffed to 282 for realistic data
		isuav = 0;
		radartype = 0;
		class TransportMagazines{};
		class TransportWeapons{};
	...
	//Own Skins & Vehicles
	class Clanner_Base : Soldier_Crew_PMC {
		displayName = "zzz_baseclan_zzz";
		HiddenSelections[] = {""};
	...
	class Coach_DZT : Clanner_Base {
		...
		class EventHandlers: EventHandlers	{
			init = "[_this Select 0] setface ""Merc_Face16""";
			HandleIdentity = 1;
		};
		class Wounds {
			tex[] = {};
	...
	class Merc_Balaclava_DZT : Clanner_Base {
		...
		class EventHandlers: EventHandlers	{
			init = "(_this select 0) setidentity ""Mask_skull""";
			HandleIdentity = 1;
		};
		class Wounds {
			tex[] = {};
	...
	class Merc_GasMask_DZT : Clanner_Base {
		displayName = "BlackOp (gas mask)";
		side = 1;
		faceType = "Man";
		identityTypes[] = {"gasmask_red"};
		weapons[] = {"Throw","Put"};
		backpack = "";
		magazines[] = {};
		respawnWeapons[] = {"Throw","Put"};
		...
		class EventHandlers: EventHandlers	{
			init = "(_this select 0) setidentity ""gasmask_red""";
			HandleIdentity = 1;
		};
		class Wounds {
			tex[] = {};
		...
		class SF_Survivor_DZT : Clanner_Base {
		displayName = "Pathfinder";
		model = "\ca\characters2\USMC\Miles";
		...
		class Wounds {
			tex[] = {};
			mat[] = {"Ca\characters2\usmc\marines\data\usmc_soldier.rvmat", "bb_mercs_desert\usmc_soldier_w1.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_at.rvmat", "ca\characters2\data\USMC_soldier_W1.rvmat", "ca\characters2\data\USMC_soldier_W2.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_CO.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_DMR.rvmat", "ca\characters2\data\USMC_soldier_W1.rvmat", "ca\characters2\data\USMC_soldier_W2.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_med.rvmat", "ca\characters2\data\USMC_soldier_W1.rvmat", "ca\characters2\data\USMC_soldier_W2.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_mine.rvmat", "ca\characters2\data\USMC_soldier_W1.rvmat", "ca\characters2\data\USMC_soldier_W2.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_saw.rvmat", "ca\characters2\data\USMC_soldier_W1.rvmat", "ca\characters2\data\USMC_soldier_W2.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_scout.rvmat", "ca\characters2\data\USMC_soldier_W1.rvmat", "ca\characters2\data\USMC_soldier_W2.rvmat", "Ca\characters2\usmc\marines\data\usmc_soldier_tl.rvmat", "ca\characters2\data\USMC_soldier_W1.rvmat", "ca\characters2\data\USMC_soldier_W2.rvmat", "Ca\characters2\usmc\marines\data\usmc_Crew.rvmat", "bb_mercs_desert\usmc_soldier_w1.rvmat", "ca\characters2\data\usmc_soldier_light.rvmat", "bb_mercs_desert\usmc_soldier_w1.rvmat", "bb_mercs_desert\usmc_soldier_w2.rvmat", "Ca\characters2\USMC\data\us_Crew.rvmat", "Ca\characters2\USMC\data\W1_us_crew.rvmat", "Ca\characters2\USMC\data\W2_us_crew.rvmat"};
		};
	};
		class Bandit_DZT : Clanner_Base {
		displayName = "Bandit";
		model = "\Ca\characters2\opforins\Ins_Lopotev";
		//faceType = "Terrorist Mask 1";
		side = 1;
		identityTypes[] = {"Terrorist_mask"};
		weapons[] = {"Throw","Put"};
		backpack = "";
		magazines[] = {};
		respawnWeapons[] = {"Throw","Put"};
		...
		canHideBodies = 1;
		class EventHandlers: EventHandlers	{
			init = "(_this select 0) setidentity ""Terrorist_mask""";
			HandleIdentity = 1;
		};
		class Wounds {
			tex[] = {};
	...
	class Trinity_Island {
		displayName = "Trinity Island";
	};
};
	class VWGolf; // External class
	class qin_evoix_orange; // External class qin_evoix_orange
	class evoix_overall_DZT : qin_evoix_orange {
		extCameraPosition[] = {0, 0.5, -8};
		wheelCircumference = 1.0;
		terraincoef = 1e-011;
		vehicleClass = "Trinity Island";
		armor = 25;
		maxSpeed = 145;	// max speed on level road, km/h - rebalanced to 145
		model = "\qin_evoix\qin_evoix_orange.p3d";
		DisplayName = "Lancer EVO IX (Orange) - DZT";
		fuelCapacity = 70;
	...
	class evoix_green_DZT : evoix_overall_DZT {
		model = "\qin_evoix\qin_evoix_green.p3d";
		DisplayName = "Lancer EVO IX (Green) - DZT";
	};
	
	class evoix_black_DZT : evoix_overall_DZT {
		model = "\qin_evoix\qin_evoix_black.p3d";
		DisplayName = "Lancer EVO IX (Black) - DZT";
	};
	
	class evoix_blue_DZT : evoix_overall_DZT {
		model = "\qin_evoix\qin_evoix_blue.p3d";
		DisplayName = "Lancer EVO IX (Blue) - DZT";
	};
	
	class evoix_gray_DZT : evoix_overall_DZT {
		model = "\qin_evoix\qin_evoix_gray.p3d";
		DisplayName = "Lancer EVO IX (Gray) - DZT";
	};
	
	class evoix_red_DZT : evoix_overall_DZT {
		model = "\qin_evoix\qin_evoix_red.p3d";
		DisplayName = "Lancer EVO IX (Red) - DZT";
	};
	//End own skinz & vehicles
	//start own bags
	class UsBasicBag; //External Class Reference
	class PRACS_SNG_BP_DZT : USBasicBag {
		scope = public;
		displayName = "Small Alice Pack - DZT";
		model = "\pracs_weapons\backpack\PRACS_SNG_BP.p3d";
		picture = "\ca\weapons_e\data\icons\backpack_TK_ALICE_CA.paa";
		icon = "\ca\weapons_e\data\icons\mapIcon_backpack_CA.paa";
		transportMaxWeapons = 1;
		transportMaxMagazines = 14;
	};
	class PRACS_M_BP_DZT : USBasicBag {
		scope = public;
		displayName = "Medium Mountaineer Pack";
		model = "\pracs_weapons\backpack\PRACS_M_BP.p3d";
		picture = "\ca\weapons_e\data\icons\backpack_TK_ALICE_CA.paa";
		icon = "\ca\weapons_e\data\icons\mapIcon_backpack_CA.paa";
		transportMaxWeapons = 2;
		transportMaxMagazines = 19;
	};
	class PRACS_M_MED_BP_DZT : USBasicBag {
		scope = public;
		displayName = "Heavy Mountaineer Pack - DZT";
		model = "\pracs_weapons\backpack\PRACS_M_MED_BP.p3d";
		picture = "\ca\weapons_e\data\icons\backpack_TK_ALICE_CA.paa";
		icon = "\ca\weapons_e\data\icons\mapIcon_backpack_CA.paa";
		transportMaxWeapons = 3;
