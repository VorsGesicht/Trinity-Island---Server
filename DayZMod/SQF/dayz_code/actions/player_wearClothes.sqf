...
//Add the drölfmillions custom skins for trinity
switch (_item) do {
	...
	case "Skin_Merc_Balaclava_DZT": {
		_model = "Merc_Balaclava_DZT";
	};
	case "Skin_Merc_GasMask_DZT": {
		_model = "Merc_GasMask_DZT";
	};
	case "Skin_SF_Survivor_DZT": {
		_model = "SF_Survivor_DZT";
	};
